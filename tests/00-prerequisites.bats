...
@test "test-vm-a2 has finished cloud-final" {
    assert_cloud_init_complete test-vm-a2 cudn1
}
...
@test "test-vm-a2 has HTTP service responding" {
    assert_http_responding test-vm-a2 cudn1 "Test VM A2"
}
